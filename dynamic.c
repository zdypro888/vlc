...
bool dynamic_load(const char *path)
{
    ...
    _libvlc_audio_equalizer_get_preset_name = (p_libvlc_audio_equalizer_get_preset_name)dlsym(handle, "libvlc_audio_equalizer_get_preset_name");
    _libvlc_media_player_set_position = (p_libvlc_media_player_set_position)dlsym(handle, "libvlc_media_player_set_position");
    _libvlc_media_player_get_chapter = (p_libvlc_media_player_get_chapter)dlsym(handle, "libvlc_media_player_get_chapter");
    _libvlc_audio_toggle_mute = (p_libvlc_audio_toggle_mute)dlsym(handle, "libvlc_audio_toggle_mute");
    _libvlc_media_track_hold = (p_libvlc_media_track_hold)dlsym(handle, "libvlc_media_track_hold");
    _libvlc_picture_release = (p_libvlc_picture_release)dlsym(handle, "libvlc_picture_release");
    _libvlc_video_set_crop_ratio = (p_libvlc_video_set_crop_ratio)dlsym(handle, "libvlc_video_set_crop_ratio");
    _libvlc_media_player_select_tracks = (p_libvlc_media_player_select_tracks)dlsym(handle, "libvlc_media_player_select_tracks");
    _libvlc_video_set_aspect_ratio = (p_libvlc_video_set_aspect_ratio)dlsym(handle, "libvlc_video_set_aspect_ratio");
    _libvlc_media_list_release = (p_libvlc_media_list_release)dlsym(handle, "libvlc_media_list_release");
    _libvlc_media_get_duration = (p_libvlc_media_get_duration)dlsym(handle, "libvlc_media_get_duration");
    _libvlc_media_list_item_at_index = (p_libvlc_media_list_item_at_index)dlsym(handle, "libvlc_media_list_item_at_index");
    _libvlc_set_exit_handler = (p_libvlc_set_exit_handler)dlsym(handle, "libvlc_set_exit_handler");
    _libvlc_free = (p_libvlc_free)dlsym(handle, "libvlc_free");
    _libvlc_media_player_set_hwnd = (p_libvlc_media_player_set_hwnd)dlsym(handle, "libvlc_media_player_set_hwnd");
    _libvlc_media_parse_stop = (p_libvlc_media_parse_stop)dlsym(handle, "libvlc_media_parse_stop");
    _libvlc_media_player_set_renderer = (p_libvlc_media_player_set_renderer)dlsym(handle, "libvlc_media_player_set_renderer");
    ...
    _libvlc_audio_get_track = (p_libvlc_audio_get_track)dlsym(handle, "libvlc_audio_get_track");
    _libvlc_audio_equalizer_get_preset_count = (p_libvlc_audio_equalizer_get_preset_count)dlsym(handle, "libvlc_audio_equalizer_get_preset_count");
    _libvlc_media_get_stats = (p_libvlc_media_get_stats)dlsym(handle, "libvlc_media_get_stats");
    _libvlc_media_set_user_data = (p_libvlc_media_set_user_data)dlsym(handle, "libvlc_media_set_user_data");
    _libvlc_media_player_unselect_track_type = (p_libvlc_media_player_unselect_track_type)dlsym(handle, "libvlc_media_player_unselect_track_type");
    _libvlc_media_list_player_set_playback_mode = (p_libvlc_media_list_player_set_playback_mode)dlsym(handle, "libvlc_media_list_player_set_playback_mode");
    _libvlc_audio_get_channel = (p_libvlc_audio_get_channel)dlsym(handle, "libvlc_audio_get_channel");
    _libvlc_media_player_can_pause = (p_libvlc_media_player_can_pause)dlsym(handle, "libvlc_media_player_can_pause");
    _libvlc_audio_filter_list_get = (p_libvlc_audio_filter_list_get)dlsym(handle, "libvlc_audio_filter_list_get");
    _libvlc_renderer_item_name = (p_libvlc_renderer_item_name)dlsym(handle, "libvlc_renderer_item_name");
    _libvlc_audio_set_volume = (p_libvlc_audio_set_volume)dlsym(handle, "libvlc_audio_set_volume");
    _libvlc_media_player_get_length = (p_libvlc_media_player_get_length)dlsym(handle, "libvlc_media_player_get_length");
    _libvlc_media_list_player_set_media_list = (p_libvlc_media_list_player_set_media_list)dlsym(handle, "libvlc_media_list_player_set_media_list");
    _libvlc_media_player_get_xwindow = (p_libvlc_media_player_get_xwindow)dlsym(handle, "libvlc_media_player_get_xwindow");
    _libvlc_audio_equalizer_get_preamp = (p_libvlc_audio_equalizer_get_preamp)dlsym(handle, "libvlc_audio_equalizer_get_preamp");
    _libvlc_media_is_parsed = (p_libvlc_media_is_parsed)dlsym(handle, "libvlc_media_is_parsed");
    _libvlc_video_get_adjust_float = (p_libvlc_video_get_adjust_float)dlsym(handle, "libvlc_video_get_adjust_float");
    _libvlc_player_programlist_count = (p_libvlc_player_programlist_count)dlsym(handle, "libvlc_player_programlist_count");
    _libvlc_media_thumbnail_request_destroy = (p_libvlc_media_thumbnail_request_destroy)dlsym(handle, "libvlc_media_thumbnail_request_destroy");
    _libvlc_media_player_select_track = (p_libvlc_media_player_select_track)dlsym(handle, "libvlc_media_player_select_track");
    _libvlc_video_set_spu_delay = (p_libvlc_video_set_spu_delay)dlsym(handle, "libvlc_video_set_spu_delay");
    _libvlc_media_add_option = (p_libvlc_media_add_option)dlsym(handle, "libvlc_media_add_option");
    _libvlc_get_compiler = (p_libvlc_get_compiler)dlsym(handle, "libvlc_get_compiler");
    _libvlc_media_duplicate = (p_libvlc_media_duplicate)dlsym(handle, "libvlc_media_duplicate");
    _libvlc_video_set_adjust_float = (p_libvlc_video_set_adjust_float)dlsym(handle, "libvlc_video_set_adjust_float");
    _libvlc_media_player_get_title_count = (p_libvlc_media_player_get_title_count)dlsym(handle, "libvlc_media_player_get_title_count");
    _libvlc_media_new_fd = (p_libvlc_media_new_fd)dlsym(handle, "libvlc_media_new_fd");
    _libvlc_renderer_item_type = (p_libvlc_renderer_item_type)dlsym(handle, "libvlc_renderer_item_type");
    _libvlc_media_player_get_programlist = (p_libvlc_media_player_get_programlist)dlsym(handle, "libvlc_media_player_get_programlist");
    _libvlc_media_list_count = (p_libvlc_media_list_count)dlsym(handle, "libvlc_media_list_count");
    _libvlc_media_discoverer_list_get = (p_libvlc_media_discoverer_list_get)dlsym(handle, "libvlc_media_discoverer_list_get");
    _libvlc_media_player_set_role = (p_libvlc_media_player_set_role)dlsym(handle, "libvlc_media_player_set_role");
    _libvlc_media_discoverer_start = (p_libvlc_media_discoverer_start)dlsym(handle, "libvlc_media_discoverer_start");
    _libvlc_video_get_spu_delay = (p_libvlc_video_get_spu_delay)dlsym(handle, "libvlc_video_get_spu_delay");
    _libvlc_media_get_user_data = (p_libvlc_media_get_user_data)dlsym(handle, "libvlc_media_get_user_data");
    _libvlc_audio_get_delay = (p_libvlc_audio_get_delay)dlsym(handle, "libvlc_audio_get_delay");
    _libvlc_module_description_list_release = (p_libvlc_module_description_list_release)dlsym(handle, "libvlc_module_description_list_release");
    _libvlc_video_update_viewpoint = (p_libvlc_video_update_viewpoint)dlsym(handle, "libvlc_video_update_viewpoint");
    _libvlc_video_get_spu_description = (p_libvlc_video_get_spu_description)dlsym(handle, "libvlc_video_get_spu_description");
    _libvlc_media_player_set_title = (p_libvlc_media_player_set_title)dlsym(handle, "libvlc_media_player_set_title");
    _libvlc_video_set_spu = (p_libvlc_video_set_spu)dlsym(handle, "libvlc_video_set_spu");
    _libvlc_picture_type = (p_libvlc_picture_type)dlsym(handle, "libvlc_picture_type");
    _libvlc_audio_output_set = (p_libvlc_audio_output_set)dlsym(handle, "libvlc_audio_output_set");
    _libvlc_audio_equalizer_new_from_preset = (p_libvlc_audio_equalizer_new_from_preset)dlsym(handle, "libvlc_audio_equalizer_new_from_preset");
    _libvlc_audio_set_track = (p_libvlc_audio_set_track)dlsym(handle, "libvlc_audio_set_track");
    _libvlc_media_player_has_vout = (p_libvlc_media_player_has_vout)dlsym(handle, "libvlc_media_player_has_vout");
    _libvlc_media_release = (p_libvlc_media_release)dlsym(handle, "libvlc_media_release");
    _libvlc_player_program_delete = (p_libvlc_player_program_delete)dlsym(handle, "libvlc_player_program_delete");
    _libvlc_audio_set_callbacks = (p_libvlc_audio_set_callbacks)dlsym(handle, "libvlc_audio_set_callbacks");
    _libvlc_audio_set_format = (p_libvlc_audio_set_format)dlsym(handle, "libvlc_audio_set_format");
    _libvlc_media_player_select_program_id = (p_libvlc_media_player_select_program_id)dlsym(handle, "libvlc_media_player_select_program_id");
    _libvlc_media_tracks_release = (p_libvlc_media_tracks_release)dlsym(handle, "libvlc_media_tracks_release");
    _libvlc_audio_equalizer_get_amp_at_index = (p_libvlc_audio_equalizer_get_amp_at_index)dlsym(handle, "libvlc_audio_equalizer_get_amp_at_index");
    _libvlc_media_track_release = (p_libvlc_media_track_release)dlsym(handle, "libvlc_media_track_release");
    _libvlc_media_player_is_playing = (p_libvlc_media_player_is_playing)dlsym(handle, "libvlc_media_player_is_playing");
    _libvlc_title_descriptions_release = (p_libvlc_title_descriptions_release)dlsym(handle, "libvlc_title_descriptions_release");
    _libvlc_media_list_is_readonly = (p_libvlc_media_list_is_readonly)dlsym(handle, "libvlc_media_list_is_readonly");
    _libvlc_video_set_spu_text_scale = (p_libvlc_video_set_spu_text_scale)dlsym(handle, "libvlc_video_set_spu_text_scale");
    _libvlc_media_player_add_slave = (p_libvlc_media_player_add_slave)dlsym(handle, "libvlc_media_player_add_slave");
    _libvlc_log_get_context = (p_libvlc_log_get_context)dlsym(handle, "libvlc_log_get_context");
    _libvlc_media_player_release = (p_libvlc_media_player_release)dlsym(handle, "libvlc_media_player_release");
    _libvlc_video_set_logo_string = (p_libvlc_video_set_logo_string)dlsym(handle, "libvlc_video_set_logo_string");
    _libvlc_video_get_spu_text_scale = (p_libvlc_video_get_spu_text_scale)dlsym(handle, "libvlc_video_get_spu_text_scale");
    _libvlc_media_list_player_retain = (p_libvlc_media_list_player_retain)dlsym(handle, "libvlc_media_list_player_retain");
    _libvlc_playlist_play = (p_libvlc_playlist_play)dlsym(handle, "libvlc_playlist_play");
    _libvlc_media_list_player_pause = (p_libvlc_media_list_player_pause)dlsym(handle, "libvlc_media_list_player_pause");
    _libvlc_media_player_set_equalizer = (p_libvlc_media_player_set_equalizer)dlsym(handle, "libvlc_media_player_set_equalizer");
    _libvlc_media_list_player_play_item_at_index = (p_libvlc_media_list_player_play_item_at_index)dlsym(handle, "libvlc_media_list_player_play_item_at_index");
    _libvlc_media_tracklist_count = (p_libvlc_media_tracklist_count)dlsym(handle, "libvlc_media_tracklist_count");
    _libvlc_video_set_callbacks = (p_libvlc_video_set_callbacks)dlsym(handle, "libvlc_video_set_callbacks");
    _libvlc_video_get_teletext = (p_libvlc_video_get_teletext)dlsym(handle, "libvlc_video_get_teletext");
    ...
    _libvlc_media_player_select_tracks_by_ids = (p_libvlc_media_player_select_tracks_by_ids)dlsym(handle, "libvlc_media_player_select_tracks_by_ids");
    _libvlc_media_add_option_flag = (p_libvlc_media_add_option_flag)dlsym(handle, "libvlc_media_add_option_flag");
    _libvlc_media_player_set_xwindow = (p_libvlc_media_player_set_xwindow)dlsym(handle, "libvlc_media_player_set_xwindow");
    _libvlc_audio_set_channel = (p_libvlc_audio_set_channel)dlsym(handle, "libvlc_audio_set_channel");
    _libvlc_media_player_get_role = (p_libvlc_media_player_get_role)dlsym(handle, "libvlc_media_player_get_role");
    _libvlc_media_list_add_media = (p_libvlc_media_list_add_media)dlsym(handle, "libvlc_media_list_add_media");
    _libvlc_media_list_lock = (p_libvlc_media_list_lock)dlsym(handle, "libvlc_media_list_lock");
    _libvlc_media_slaves_clear = (p_libvlc_media_slaves_clear)dlsym(handle, "libvlc_media_slaves_clear");
    _libvlc_media_player_get_chapter_count_for_title = (p_libvlc_media_player_get_chapter_count_for_title)dlsym(handle, "libvlc_media_player_get_chapter_count_for_title");
    _libvlc_log_unset = (p_libvlc_log_unset)dlsym(handle, "libvlc_log_unset");
    _libvlc_video_get_track = (p_libvlc_video_get_track)dlsym(handle, "libvlc_video_get_track");
    _libvlc_clock = (p_libvlc_clock)dlsym(handle, "libvlc_clock");
    _libvlc_renderer_discoverer_start = (p_libvlc_renderer_discoverer_start)dlsym(handle, "libvlc_renderer_discoverer_start");
    _libvlc_video_get_spu = (p_libvlc_video_get_spu)dlsym(handle, "libvlc_video_get_spu");
    _libvlc_set_user_agent = (p_libvlc_set_user_agent)dlsym(handle, "libvlc_set_user_agent");
    _libvlc_log_set_file = (p_libvlc_log_set_file)dlsym(handle, "libvlc_log_set_file");
    _libvlc_media_tracklist_delete = (p_libvlc_media_tracklist_delete)dlsym(handle, "libvlc_media_tracklist_delete");
    _libvlc_media_discoverer_stop = (p_libvlc_media_discoverer_stop)dlsym(handle, "libvlc_media_discoverer_stop");
    _libvlc_video_set_mouse_input = (p_libvlc_video_set_mouse_input)dlsym(handle, "libvlc_video_set_mouse_input");
    _libvlc_media_list_event_manager = (p_libvlc_media_list_event_manager)dlsym(handle, "libvlc_media_list_event_manager");
    _libvlc_log_get_object = (p_libvlc_log_get_object)dlsym(handle, "libvlc_log_get_object");
    _libvlc_media_event_manager = (p_libvlc_media_event_manager)dlsym(handle, "libvlc_media_event_manager");
    _libvlc_media_get_parsed_status = (p_libvlc_media_get_parsed_status)dlsym(handle, "libvlc_media_get_parsed_status");
    _libvlc_video_get_cursor = (p_libvlc_video_get_cursor)dlsym(handle, "libvlc_video_get_cursor");
    _libvlc_video_get_aspect_ratio = (p_libvlc_video_get_aspect_ratio)dlsym(handle, "libvlc_video_get_aspect_ratio");
    _libvlc_media_set_meta = (p_libvlc_media_set_meta)dlsym(handle, "libvlc_media_set_meta");
    _libvlc_media_player_get_position = (p_libvlc_media_player_get_position)dlsym(handle, "libvlc_media_player_get_position");
    _libvlc_media_list_new = (p_libvlc_media_list_new)dlsym(handle, "libvlc_media_list_new");
    _libvlc_toggle_fullscreen = (p_libvlc_toggle_fullscreen)dlsym(handle, "libvlc_toggle_fullscreen");
    _libvlc_video_filter_list_get = (p_libvlc_video_filter_list_get)dlsym(handle, "libvlc_video_filter_list_get");
    _libvlc_vprinterr = (p_libvlc_vprinterr)dlsym(handle, "libvlc_vprinterr");
    _libvlc_media_player_navigate = (p_libvlc_media_player_navigate)dlsym(handle, "libvlc_media_player_navigate");
    _libvlc_dialog_post_login = (p_libvlc_dialog_post_login)dlsym(handle, "libvlc_dialog_post_login");
    _libvlc_audio_equalizer_release = (p_libvlc_audio_equalizer_release)dlsym(handle, "libvlc_audio_equalizer_release");
    _libvlc_video_set_key_input = (p_libvlc_video_set_key_input)dlsym(handle, "libvlc_video_set_key_input");
    _libvlc_video_set_scale = (p_libvlc_video_set_scale)dlsym(handle, "libvlc_video_set_scale");
    _libvlc_set_fullscreen = (p_libvlc_set_fullscreen)dlsym(handle, "libvlc_set_fullscreen");
    _libvlc_video_get_scale = (p_libvlc_video_get_scale)dlsym(handle, "libvlc_video_get_scale");
    _libvlc_media_list_player_event_manager = (p_libvlc_media_list_player_event_manager)dlsym(handle, "libvlc_media_list_player_event_manager");
    _libvlc_media_list_player_is_playing = (p_libvlc_media_list_player_is_playing)dlsym(handle, "libvlc_media_list_player_is_playing");
    _libvlc_media_player_program_scrambled = (p_libvlc_media_player_program_scrambled)dlsym(handle, "libvlc_media_player_program_scrambled");
    _libvlc_audio_output_device_list_get = (p_libvlc_audio_output_device_list_get)dlsym(handle, "libvlc_audio_output_device_list_get");
    _libvlc_media_player_get_rate = (p_libvlc_media_player_get_rate)dlsym(handle, "libvlc_media_player_get_rate");
    _libvlc_video_take_snapshot = (p_libvlc_video_take_snapshot)dlsym(handle, "libvlc_video_take_snapshot");
    _libvlc_media_list_index_of_item = (p_libvlc_media_list_index_of_item)dlsym(handle, "libvlc_media_list_index_of_item");
    _libvlc_video_set_track = (p_libvlc_video_set_track)dlsym(handle, "libvlc_video_set_track");
    _libvlc_renderer_item_icon_uri = (p_libvlc_renderer_item_icon_uri)dlsym(handle, "libvlc_renderer_item_icon_uri");
    _libvlc_picture_list_count = (p_libvlc_picture_list_count)dlsym(handle, "libvlc_picture_list_count");
    _libvlc_media_player_set_time = (p_libvlc_media_player_set_time)dlsym(handle, "libvlc_media_player_set_time");
    _libvlc_audio_output_device_list_release = (p_libvlc_audio_output_device_list_release)dlsym(handle, "libvlc_audio_output_device_list_release");
    _libvlc_media_player_get_hwnd = (p_libvlc_media_player_get_hwnd)dlsym(handle, "libvlc_media_player_get_hwnd");
    _libvlc_media_player_is_seekable = (p_libvlc_media_player_is_seekable)dlsym(handle, "libvlc_media_player_is_seekable");
    _libvlc_video_set_teletext = (p_libvlc_video_set_teletext)dlsym(handle, "libvlc_video_set_teletext");
    _libvlc_video_set_marquee_int = (p_libvlc_video_set_marquee_int)dlsym(handle, "libvlc_video_set_marquee_int");
    _libvlc_audio_output_device_get = (p_libvlc_audio_output_device_get)dlsym(handle, "libvlc_audio_output_device_get");
    _libvlc_media_list_player_get_media_player = (p_libvlc_media_list_player_get_media_player)dlsym(handle, "libvlc_media_list_player_get_media_player");
    _libvlc_video_get_adjust_int = (p_libvlc_video_get_adjust_int)dlsym(handle, "libvlc_video_get_adjust_int");
    _libvlc_media_player_get_track_from_id = (p_libvlc_media_player_get_track_from_id)dlsym(handle, "libvlc_media_player_get_track_from_id");
    _libvlc_audio_equalizer_set_preamp = (p_libvlc_audio_equalizer_set_preamp)dlsym(handle, "libvlc_audio_equalizer_set_preamp");
    _libvlc_retain = (p_libvlc_retain)dlsym(handle, "libvlc_retain");
    _libvlc_media_get_tracklist = (p_libvlc_media_get_tracklist)dlsym(handle, "libvlc_media_get_tracklist");
    _libvlc_chapter_descriptions_release = (p_libvlc_chapter_descriptions_release)dlsym(handle, "libvlc_chapter_descriptions_release");
    _libvlc_video_get_spu_count = (p_libvlc_video_get_spu_count)dlsym(handle, "libvlc_video_get_spu_count");
    _libvlc_audio_equalizer_new = (p_libvlc_audio_equalizer_new)dlsym(handle, "libvlc_audio_equalizer_new");
    _libvlc_picture_list_destroy = (p_libvlc_picture_list_destroy)dlsym(handle, "libvlc_picture_list_destroy");
    _libvlc_media_discoverer_media_list = (p_libvlc_media_discoverer_media_list)dlsym(handle, "libvlc_media_discoverer_media_list");
    _libvlc_media_discoverer_list_release = (p_libvlc_media_discoverer_list_release)dlsym(handle, "libvlc_media_discoverer_list_release");
    _libvlc_audio_set_mute = (p_libvlc_audio_set_mute)dlsym(handle, "libvlc_audio_set_mute");
    _libvlc_audio_equalizer_set_amp_at_index = (p_libvlc_audio_equalizer_set_amp_at_index)dlsym(handle, "libvlc_audio_equalizer_set_amp_at_index");
    _libvlc_media_player_get_state = (p_libvlc_media_player_get_state)dlsym(handle, "libvlc_media_player_get_state");
    _libvlc_audio_get_track_count = (p_libvlc_audio_get_track_count)dlsym(handle, "libvlc_audio_get_track_count");
    _libvlc_media_player_get_nsobject = (p_libvlc_media_player_get_nsobject)dlsym(handle, "libvlc_media_player_get_nsobject");
    _libvlc_media_player_get_selected_track = (p_libvlc_media_player_get_selected_track)dlsym(handle, "libvlc_media_player_get_selected_track");
    _libvlc_media_player_get_tracklist = (p_libvlc_media_player_get_tracklist)dlsym(handle, "libvlc_media_player_get_tracklist");
    _libvlc_video_set_logo_int = (p_libvlc_video_set_logo_int)dlsym(handle, "libvlc_video_set_logo_int");
    _libvlc_renderer_discoverer_stop = (p_libvlc_renderer_discoverer_stop)dlsym(handle, "libvlc_renderer_discoverer_stop");
    _libvlc_media_parse = (p_libvlc_media_parse)dlsym(handle, "libvlc_media_parse");
    _libvlc_new = (p_libvlc_new)dlsym(handle, "libvlc_new");
    _libvlc_media_list_player_get_state = (p_libvlc_media_list_player_get_state)dlsym(handle, "libvlc_media_list_player_get_state");
    _libvlc_media_player_event_manager = (p_libvlc_media_player_event_manager)dlsym(handle, "libvlc_media_player_event_manager");
    _libvlc_audio_equalizer_get_band_frequency = (p_libvlc_audio_equalizer_get_band_frequency)dlsym(handle, "libvlc_audio_equalizer_get_band_frequency");
    _libvlc_media_get_mrl = (p_libvlc_media_get_mrl)dlsym(handle, "libvlc_media_get_mrl");
    _libvlc_video_get_marquee_int = (p_libvlc_video_get_marquee_int)dlsym(handle, "libvlc_video_get_marquee_int");
    _libvlc_track_description_list_release = (p_libvlc_track_description_list_release)dlsym(handle, "libvlc_track_description_list_release");
    _libvlc_media_tracklist_at = (p_libvlc_media_tracklist_at)dlsym(handle, "libvlc_media_tracklist_at");
    _libvlc_clearerr = (p_libvlc_clearerr)dlsym(handle, "libvlc_clearerr");
    _libvlc_audio_output_list_release = (p_libvlc_audio_output_list_release)dlsym(handle, "libvlc_audio_output_list_release");
    _libvlc_picture_get_stride = (p_libvlc_picture_get_stride)dlsym(handle, "libvlc_picture_get_stride");
    _libvlc_release = (p_libvlc_release)dlsym(handle, "libvlc_release");
    _libvlc_media_thumbnail_request_by_time = (p_libvlc_media_thumbnail_request_by_time)dlsym(handle, "libvlc_media_thumbnail_request_by_time");
    _libvlc_video_get_track_description = (p_libvlc_video_get_track_description)dlsym(handle, "libvlc_video_get_track_description");
    _libvlc_media_list_insert_media = (p_libvlc_media_list_insert_media)dlsym(handle, "libvlc_media_list_insert_media");
    _libvlc_dialog_set_context = (p_libvlc_dialog_set_context)dlsym(handle, "libvlc_dialog_set_context");
    _libvlc_log_set = (p_libvlc_log_set)dlsym(handle, "libvlc_log_set");
    _libvlc_video_set_format = (p_libvlc_video_set_format)dlsym(handle, "libvlc_video_set_format");
    _libvlc_add_intf = (p_libvlc_add_intf)dlsym(handle, "libvlc_add_intf");
    _libvlc_media_new_callbacks = (p_libvlc_media_new_callbacks)dlsym(handle, "libvlc_media_new_callbacks");
    _libvlc_media_list_unlock = (p_libvlc_media_list_unlock)dlsym(handle, "libvlc_media_list_unlock");
    _libvlc_media_player_get_full_chapter_descriptions = (p_libvlc_media_player_get_full_chapter_descriptions)dlsym(handle, "libvlc_media_player_get_full_chapter_descriptions");
    _libvlc_audio_get_mute = (p_libvlc_audio_get_mute)dlsym(handle, "libvlc_audio_get_mute");
    _libvlc_printerr = (p_libvlc_printerr)dlsym(handle, "libvlc_printerr");
    _libvlc_media_player_new = (p_libvlc_media_player_new)dlsym(handle, "libvlc_media_player_new");
    _libvlc_media_player_set_video_title_display = (p_libvlc_media_player_set_video_title_display)dlsym(handle, "libvlc_media_player_set_video_title_display");
    _libvlc_media_get_codec_description = (p_libvlc_media_get_codec_description)dlsym(handle, "libvlc_media_get_codec_description");
    _libvlc_media_player_set_rate = (p_libvlc_media_player_set_rate)dlsym(handle, "libvlc_media_player_set_rate");
    _libvlc_video_set_deinterlace = (p_libvlc_video_set_deinterlace)dlsym(handle, "libvlc_video_set_deinterlace");
    _libvlc_media_player_pause = (p_libvlc_media_player_pause)dlsym(handle, "libvlc_media_player_pause");
    _libvlc_audio_output_list_get = (p_libvlc_audio_output_list_get)dlsym(handle, "libvlc_audio_output_list_get");
    _libvlc_media_get_state = (p_libvlc_media_get_state)dlsym(handle, "libvlc_media_get_state");
    _libvlc_audio_set_format_callbacks = (p_libvlc_audio_set_format_callbacks)dlsym(handle, "libvlc_audio_set_format_callbacks");
    _libvlc_media_discoverer_new = (p_libvlc_media_discoverer_new)dlsym(handle, "libvlc_media_discoverer_new");
    _libvlc_renderer_discoverer_event_manager = (p_libvlc_renderer_discoverer_event_manager)dlsym(handle, "libvlc_renderer_discoverer_event_manager");
    _libvlc_media_slaves_release = (p_libvlc_media_slaves_release)dlsym(handle, "libvlc_media_slaves_release");
    _libvlc_media_new_location = (p_libvlc_media_new_location)dlsym(handle, "libvlc_media_new_location");
    ...
    _libvlc_renderer_item_release = (p_libvlc_renderer_item_release)dlsym(handle, "libvlc_renderer_item_release");
    _libvlc_player_programlist_at = (p_libvlc_player_programlist_at)dlsym(handle, "libvlc_player_programlist_at");
    _libvlc_dialog_dismiss = (p_libvlc_dialog_dismiss)dlsym(handle, "libvlc_dialog_dismiss");
    _libvlc_delay = (p_libvlc_delay)dlsym(handle, "libvlc_delay");
    _libvlc_picture_list_at = (p_libvlc_picture_list_at)dlsym(handle, "libvlc_picture_list_at");
    _libvlc_media_retain = (p_libvlc_media_retain)dlsym(handle, "libvlc_media_retain");
    _libvlc_media_player_get_title = (p_libvlc_media_player_get_title)dlsym(handle, "libvlc_media_player_get_title");
    _libvlc_media_get_meta = (p_libvlc_media_get_meta)dlsym(handle, "libvlc_media_get_meta");
    _libvlc_media_list_player_next = (p_libvlc_media_list_player_next)dlsym(handle, "libvlc_media_list_player_next");
    _libvlc_media_new_as_node = (p_libvlc_media_new_as_node)dlsym(handle, "libvlc_media_new_as_node");
    _libvlc_media_list_player_release = (p_libvlc_media_list_player_release)dlsym(handle, "libvlc_media_list_player_release");
    _libvlc_media_list_player_play = (p_libvlc_media_list_player_play)dlsym(handle, "libvlc_media_list_player_play");
    _libvlc_media_player_next_frame = (p_libvlc_media_player_next_frame)dlsym(handle, "libvlc_media_player_next_frame");
    _libvlc_picture_get_width = (p_libvlc_picture_get_width)dlsym(handle, "libvlc_picture_get_width");
    _libvlc_media_thumbnail_request_by_pos = (p_libvlc_media_thumbnail_request_by_pos)dlsym(handle, "libvlc_media_thumbnail_request_by_pos");
    _libvlc_media_player_get_selected_program = (p_libvlc_media_player_get_selected_program)dlsym(handle, "libvlc_media_player_get_selected_program");
    _libvlc_media_list_player_previous = (p_libvlc_media_list_player_previous)dlsym(handle, "libvlc_media_list_player_previous");
    _libvlc_media_player_set_nsobject = (p_libvlc_media_player_set_nsobject)dlsym(handle, "libvlc_media_player_set_nsobject");
    _libvlc_media_save_meta = (p_libvlc_media_save_meta)dlsym(handle, "libvlc_media_save_meta");
    _libvlc_media_player_new_from_media = (p_libvlc_media_player_new_from_media)dlsym(handle, "libvlc_media_player_new_from_media");
    _libvlc_media_player_get_chapter_count = (p_libvlc_media_player_get_chapter_count)dlsym(handle, "libvlc_media_player_get_chapter_count");
    _libvlc_media_player_next_chapter = (p_libvlc_media_player_next_chapter)dlsym(handle, "libvlc_media_player_next_chapter");
    _libvlc_audio_get_track_description = (p_libvlc_audio_get_track_description)dlsym(handle, "libvlc_audio_get_track_description");
    _libvlc_media_list_player_set_pause = (p_libvlc_media_list_player_set_pause)dlsym(handle, "libvlc_media_list_player_set_pause");
    _libvlc_dialog_set_callbacks = (p_libvlc_dialog_set_callbacks)dlsym(handle, "libvlc_dialog_set_callbacks");
    _libvlc_media_player_set_media = (p_libvlc_media_player_set_media)dlsym(handle, "libvlc_media_player_set_media");
    _libvlc_dialog_get_context = (p_libvlc_dialog_get_context)dlsym(handle, "libvlc_dialog_get_context");
    _libvlc_get_version = (p_libvlc_get_version)dlsym(handle, "libvlc_get_version");
    _libvlc_media_slaves_add = (p_libvlc_media_slaves_add)dlsym(handle, "libvlc_media_slaves_add");
    _libvlc_errmsg = (p_libvlc_errmsg)dlsym(handle, "libvlc_errmsg");
    _libvlc_audio_get_volume = (p_libvlc_audio_get_volume)dlsym(handle, "libvlc_audio_get_volume");
    _libvlc_renderer_discoverer_list_release = (p_libvlc_renderer_discoverer_list_release)dlsym(handle, "libvlc_renderer_discoverer_list_release");
    _libvlc_media_player_get_media = (p_libvlc_media_player_get_media)dlsym(handle, "libvlc_media_player_get_media");
    _libvlc_media_player_set_android_context = (p_libvlc_media_player_set_android_context)dlsym(handle, "libvlc_media_player_set_android_context");
    _libvlc_media_player_set_chapter = (p_libvlc_media_player_set_chapter)dlsym(handle, "libvlc_media_player_set_chapter");
    _libvlc_media_list_remove_index = (p_libvlc_media_list_remove_index)dlsym(handle, "libvlc_media_list_remove_index");
    _libvlc_media_player_get_program_from_id = (p_libvlc_media_player_get_program_from_id)dlsym(handle, "libvlc_media_player_get_program_from_id");
    _libvlc_picture_get_height = (p_libvlc_picture_get_height)dlsym(handle, "libvlc_picture_get_height");
    _libvlc_video_set_crop_border = (p_libvlc_video_set_crop_border)dlsym(handle, "libvlc_video_set_crop_border");
    _libvlc_media_parse_with_options = (p_libvlc_media_parse_with_options)dlsym(handle, "libvlc_media_parse_with_options");
    _libvlc_media_player_retain = (p_libvlc_media_player_retain)dlsym(handle, "libvlc_media_player_retain");
    _libvlc_video_get_track_count = (p_libvlc_video_get_track_count)dlsym(handle, "libvlc_video_get_track_count");
    _libvlc_media_get_type = (p_libvlc_media_get_type)dlsym(handle, "libvlc_media_get_type");
    _libvlc_audio_output_device_enum = (p_libvlc_audio_output_device_enum)dlsym(handle, "libvlc_audio_output_device_enum");
    _libvlc_video_set_marquee_string = (p_libvlc_video_set_marquee_string)dlsym(handle, "libvlc_video_set_marquee_string");
    _libvlc_audio_output_device_set = (p_libvlc_audio_output_device_set)dlsym(handle, "libvlc_audio_output_device_set");
    _libvlc_picture_save = (p_libvlc_picture_save)dlsym(handle, "libvlc_picture_save");
    _libvlc_set_app_id = (p_libvlc_set_app_id)dlsym(handle, "libvlc_set_app_id");
    _libvlc_renderer_item_flags = (p_libvlc_renderer_item_flags)dlsym(handle, "libvlc_renderer_item_flags");
    _libvlc_renderer_discoverer_new = (p_libvlc_renderer_discoverer_new)dlsym(handle, "libvlc_renderer_discoverer_new");
    _libvlc_picture_retain = (p_libvlc_picture_retain)dlsym(handle, "libvlc_picture_retain");
    _libvlc_renderer_item_hold = (p_libvlc_renderer_item_hold)dlsym(handle, "libvlc_renderer_item_hold");
    _libvlc_video_get_logo_int = (p_libvlc_video_get_logo_int)dlsym(handle, "libvlc_video_get_logo_int");
    _libvlc_video_set_format_callbacks = (p_libvlc_video_set_format_callbacks)dlsym(handle, "libvlc_video_set_format_callbacks");
    _libvlc_media_player_previous_chapter = (p_libvlc_media_player_previous_chapter)dlsym(handle, "libvlc_media_player_previous_chapter");
    _libvlc_get_fullscreen = (p_libvlc_get_fullscreen)dlsym(handle, "libvlc_get_fullscreen");
    _libvlc_picture_get_time = (p_libvlc_picture_get_time)dlsym(handle, "libvlc_picture_get_time");
    _libvlc_media_player_play = (p_libvlc_media_player_play)dlsym(handle, "libvlc_media_player_play");
    _libvlc_media_discoverer_release = (p_libvlc_media_discoverer_release)dlsym(handle, "libvlc_media_discoverer_release");
    _libvlc_audio_set_delay = (p_libvlc_audio_set_delay)dlsym(handle, "libvlc_audio_set_delay");
    _libvlc_media_thumbnail_request_cancel = (p_libvlc_media_thumbnail_request_cancel)dlsym(handle, "libvlc_media_thumbnail_request_cancel");
    _libvlc_media_subitems = (p_libvlc_media_subitems)dlsym(handle, "libvlc_media_subitems");
    _libvlc_media_player_get_time = (p_libvlc_media_player_get_time)dlsym(handle, "libvlc_media_player_get_time");
    _libvlc_media_slaves_get = (p_libvlc_media_slaves_get)dlsym(handle, "libvlc_media_slaves_get");
    _libvlc_media_list_player_new = (p_libvlc_media_list_player_new)dlsym(handle, "libvlc_media_list_player_new");
    _libvlc_media_list_player_set_media_player = (p_libvlc_media_list_player_set_media_player)dlsym(handle, "libvlc_media_list_player_set_media_player");
    _libvlc_get_changeset = (p_libvlc_get_changeset)dlsym(handle, "libvlc_get_changeset");
    _libvlc_picture_get_buffer = (p_libvlc_picture_get_buffer)dlsym(handle, "libvlc_picture_get_buffer");
    _libvlc_renderer_discoverer_release = (p_libvlc_renderer_discoverer_release)dlsym(handle, "libvlc_renderer_discoverer_release");
    return true;
}